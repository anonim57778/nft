    ...
    return (
        <div className="container py-10 lg:py-20 flex flex-col gap-y-10 lg:gap-y-[60px]">
            ...
            <div className="flex flex-col gap-y-5">
                <div className="border border-card rounded-[20px] text-secondary text-xs lg:text-base font-normal py-3 px-5 grid grid-cols-2 lg:gap-[60px]">
                    ...
                    <div className="grid grid-cols-1">
                        <h1 className="text-center">Продажи</h1>
                    </div>
                </div>
